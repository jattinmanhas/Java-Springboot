...
public class TodoService {
    ...
    static {
        todos.add(new Todo(++todosCount, "jattin_manhas","Learn AWS",
                LocalDate.now().plusYears(1), false ));
        todos.add(new Todo(++todosCount, "jattin_manhas","Learn DevOps",
                LocalDate.now().plusYears(2), false ));
        todos.add(new Todo(++todosCount, "jattin_manhas","Learn Full Stack Development",
